    ...
    switch (__method.intValue ())
    {
       case 0:  // corbaServer/corba/ICorbaServer/getRehearsals
       {
         try {
           ...
           out = $rh.createReply();
           corbaServer.corba.ICorbaServerPackage.RehearsalListHelper.write (out, $result);
         } catch (corbaServer.corba.DBErrorException $ex) {
           out = $rh.createExceptionReply ();
           corbaServer.corba.DBErrorExceptionHelper.write (out, $ex);
         }
         break;
       }
