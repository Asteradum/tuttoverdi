...
public class _ICorbaServerStub extends org.omg.CORBA.portable.ObjectImpl implements corbaServer.corba.ICorbaServer
{
  ...
  public corbaServer.corba.corbaServerRehearsalDTO[] getRehearsals () throws corbaServer.corba.DBErrorException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRehearsals", true);
                $in = _invoke ($out);
                corbaServer.corba.corbaServerRehearsalDTO $result[] = corbaServer.corba.ICorbaServerPackage.RehearsalListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:corbaServer/corba/DBErrorException:1.0"))
                    throw corbaServer.corba.DBErrorExceptionHelper.read ($in);
                else
