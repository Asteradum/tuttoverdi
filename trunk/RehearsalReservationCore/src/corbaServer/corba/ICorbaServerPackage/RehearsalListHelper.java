...
/**
* corbaServer/corba/ICorbaServerPackage/RehearsalListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from idl/corbaServer.idl
* domingo 7 de marzo de 2010 22H29' CET
*/

abstract public class RehearsalListHelper
{
  private static String  _id = "IDL:corbaServer/corba/ICorbaServer/RehearsalList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (corbaServer.corba.ICorbaServerPackage.RehearsalListHelper.id (), "RehearsalList", __typeCode);
    }
    return __typeCode;
  }
